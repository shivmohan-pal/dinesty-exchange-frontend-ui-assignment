...
export const SoundFamiliar = () => {
  ...
  return (
    <div ref={myRef} id="emotions" className="sm:px-4 xs:py-3 sm:py-7 flex flex-col justify-around w-full h-[var(--full-page-height-sm)] sm:h-[var(--full-page-height)] snap-end">
