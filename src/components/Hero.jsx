      ...
      <div className="relative flex items-center p-5 sm:p-10 flex-auto bg-[var(--purple-100)] rounded-3xl overflow-hidden">
        ...
        <div className="absolute left-1/3 top-12 rotate-45">
          ...
          <Image
            ...
            src={leafSvg}
            alt='leaf' />
          <Circle className={"relative mt-4 w-12 h-12 bg-orange-200 backdrop-opacity-10"}>
            <Circle className="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 w-4 h-4 bg-red-400" />
          </Circle>
        </div>
        <Circle className={"absolute -left-5 bottom-1/3 w-12 h-12 bg-red-200 "} />
        <Circle className={"absolute -bottom-[20px] left-1/3 w-12 h-12 bg-red-400"} />

        <div className="absolute h-[35rem] w-[35rem] left-1/2 -translate-x-1/3 sm:right-9 sm:left-auto sm:translate-x-0">
        <Circle className={"absolute flex inset-[18%] bg-[var(--purple-200)]"}>
          <Image 
          className=""
          src={mobileSvg}
          alt="mobile"/>
          </Circle>
          <Circle className={"relative rotate-[360deg] transition-transform duration-[2s] ease-in-out w-full h-full border-4 border-dashed border-white"}>
            <Image
        ...
        <div className="relative w-auto backdrop-blur-sm sm:w-7/12">
          <span className="block text-lg font-light mb-3 px-1 sm:text-xl sm:font-normal">Ahead app</span>
          <h1 className="text-4xl font-bold mb sm:text-6xl" >Master your life by mastering emotions</h1>
          <div className="flex flex-col sm:flex-row gap-6 sm:items-center mt-8">
            <AppleAppStoreButton />
            <div className="inine-block w-max">
              <Rating rating={5} />
              <span className="block text-center text-slate-600 font-normal text-sm">100+ Appstore reviews</span>
            </div>
          </div>
        </div>
